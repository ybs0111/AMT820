...
//	int Check_IO_Port(int n_io, int n_time = 0, int n_flag = CTL_ON);
	...
	void Set_IO_OnOff(int nIONo, int OnOff);
	int  Chk_IO_OnOff(int nIONo, int OnOff, int nWaitTime, int nLimitTime);
	int  Wait_IO_OnOff(int nIONo, int OnOff, int nWaitTime);
