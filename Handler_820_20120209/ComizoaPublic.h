...
public:
	...
	double md_allow_value[BD_MAX_MOTOR];		//이동 완료 후의 허용오차 범위 지정		// 2K14/11/04/ViboX
	...
	int mn_cmdCyl_backup[3800];		//장비 런중 동작한 실린더 최종 값저장.. 2015.09.07 - Bredmin.

	int   m_nDoneFlag[BD_MAX_MOTOR];
	DWORD m_dwDoneWaitTime[BD_MAX_MOTOR][3];	
// Operations
public:
	////////////////////////////////////////////////////////////////////////////////////////////////////////
	// 2011.1021 
